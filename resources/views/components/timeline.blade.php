        ...
        @foreach ($sertif as $certificate)
            <li class="mb-10 ms-4">
                ...
                <p data-aos="fade-left" data-aos-delay="600" class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    {{ Str::limit($certificate->description, 20) }} {{-- Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages. --}}
                </p>
